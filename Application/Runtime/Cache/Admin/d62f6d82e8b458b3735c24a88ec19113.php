...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <p><input type="text" class="am-form-field am-round" placeholder="填写文章标题" name="article_name" value="" required/></p>
        <!-- 加载编辑器的容器 -->
        ...
        <div class="am-g">
         ...
         <div class="blog-button">
            <button type="button" class="am-btn am-btn-primary am-round">发表文章</button>
           <button type="submint" class="am-btn am-btn-success am-round">立即保存</button>
         </div>
        </form>
         <!-- 表单结束 -->
        </div>
